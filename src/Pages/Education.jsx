...
export default function Education() {
  ...
  const handleViewClick = (fieldName, i, level) => {
    ...
    console.log(education[level][i][fieldName])
  ...
  const [fileNamesg1, setFileNamesg1] = useState([]);
  const [fileNamesg2, setFileNamesg2] = useState([]);
  const [fileNamesg3, setFileNamesg3] = useState([]);
  const [fileNamesg4, setFileNamesg4] = useState([]);
  ...
  const handleDeleteClickPostGraduation = async (fieldName) => {
    const educationData = education.postGraduation;
    ...
    try {
      ...
      // Update the state to remove the deleted file
      const updatedEducation = { ...education };
      updatedEducation.postGraduation[0][fieldName] = '';
  ...
  const handleDeleteClickGerman = async (fieldName, i, educationType) => {
    const updatedEducation = { ...education };
    let ed;
    console.log(fieldName, i, educationType)
    switch(fieldName){
      case  "listeningMarksheet":
        setFileNamesg1('')
         break;
      case  "speakingMarksheet":
        setFileNamesg2('')
          break;
      case  "readingMarksheet":
         setFileNamesg3('')
            break;
          
      case  "writingMarksheet":
        setFileNamesg4('')
         break;
    }
    if (!education || !education[educationType] || !education[educationType][i] || !fieldName) {
      console.error("Invalid parameters provided to handleDeleteClickGerman");
      return;
    }
    ...
    // Check if sid and urlToDelete are valid
    if ( !urlToDelete) {
      console.error("Missing URL to delete");
      return;
    }
    if (!sid) {
      console.error("Missing SID to delete");
      return;
    }
    try {
      ...
      console.error("Error in deleting file", e);
      alert("Error in deleting file. Please try again.");
    }
  };
      ...
      german: [
        {
          ...
          certificate: "",
          listeningMarksheet: "",
          listeningMarksheetDate: "",
          speakingMarksheet: "",
          speakingMarksheetDate: "",
          readingMarksheet: "",
          readingMarksheetDate: "",
          writingMarksheet: "",
          writingMarksheetDate:""
        }
      ]
    }
  );
  ...
  const University = userData?.language === 'English' ? 'School / University & Degree' : userData?.language === 'German' ? 'Schule/Universität & und Fachrichtung' : ''
  ...
  const cer = userData?.language === 'English' ? 'Certificate Date' : userData?.language === 'German' ? 'Certifikate level' : ''
...
<SimpleGrid
                    ...
                    >
                      <FormControl>
                        <FormLabel>Listening Module Marksheet (pdf)</FormLabel>
                      </FormControl>
...
<br/>
        ...
        <FormLabel>{cer} </FormLabel>
                    <FormControl  isInvalid={isSubmitted && education.german[0]['to'].trim() === ""} >

                    <Input
                      type="date"
                      value={education.german[0].listeningMarksheetDate}

                      onChange={e => {


                        const updatedEducation = { ...education };
                        updatedEducation.german[0].listeningMarksheetDate = e.target.value;
                        setEducation(updatedEducation);
                      }}
                  ...
                  <br/> <SimpleGrid
                    ...
                    >
                      <FormControl>
                        ...
                        <FormLabel>Speaking Module Marksheet(pdf)</FormLabel>
                      </FormControl>
...
<p>{fileNamesg2}</p>
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                      type="date"
                      value={education.german[0].speakingMarksheetDate}

                      onChange={e => {


                        const updatedEducation = { ...education };
                        updatedEducation.german[0].speakingMarksheetDate = e.target.value;
                        setEducation(updatedEducation);
                      }}
                  ...
                  <br/> <SimpleGrid
                    ...
                    >
                      <FormControl>
                        <FormLabel>Reading Module Marksheet(pdf)</FormLabel>
                      </FormControl>
                      <FormControl>
                        <Input
                          type="file" accept=".pdf"
...
<p>{fileNamesg3}</p>
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                      type="date"
                      value={education.german[0].readingMarksheetDate}

                      onChange={e => {

                       
                        const updatedEducation = { ...education };
                        updatedEducation.german[0].readingMarksheetDate = e.target.value;
                        setEducation(updatedEducation);
                      }}
                  ...
                  <br/> <SimpleGrid
                    ...
                    >
                      ...
                      <FormControl>
                        <FormLabel>Writing Module Marksheet(pdf)</FormLabel>
                      </FormControl>
                      <FormControl>
                        <Input
                          type="file" accept=".pdf"
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                      type="date"
                      value={education.german[0].writingMarksheetDate}

                      onChange={e => {


                        const updatedEducation = { ...education };
                        updatedEducation.german[0].writingMarksheetDate = e.target.value;
                        setEducation(updatedEducation);
                      }}
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                            type="date"
                            value={education.german[i].listeningMarksheetDate}

                            onChange={e => {

                              const updatedEducation = { ...education };
                              updatedEducation.german[i].listeningMarksheetDate = e.target.value;
                              setEducation(updatedEducation);
                            }}
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                            type="date"
                            value={education.german[i].speakingMarksheetDate}

                            onChange={e => {

                              const updatedEducation = { ...education };
                              updatedEducation.german[i].speakingMarksheetDate = e.target.value;
                              setEducation(updatedEducation);
                            }}
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                            type="date"
                            value={education.german[i].readingMarksheetDate}

                            onChange={e => {

                              const updatedEducation = { ...education };
                              updatedEducation.german[i].readingMarksheetDate = e.target.value;
                              setEducation(updatedEducation);
                            }}
        ...
        <FormLabel>{cer} </FormLabel>
                    ...
                    <Input
                            type="date"
                            value={education.german[i].writingMarksheetDate}

                            onChange={e => {

                              const updatedEducation = { ...education };
                              updatedEducation.german[i].writingMarksheetDate = e.target.value;
                              setEducation(updatedEducation);
                            }}
                ...
                onClick={e => {
                  if (education.german.length > 1) {
                    const updatedEducation = { ...education };
                    updatedEducation.german.splice(i,1);
                    setEducation(updatedEducation);
