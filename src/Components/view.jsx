...
export default function Resume() {
  ...
  const Country = info.language === 'English' ? 'Country' : info.language === 'German' ? 'Länder' : ''
            ...
            <table className="table-auto w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 border-black">{info.firstName ? info.firstName : ''}</td>
                  </tr>
                  {/* <tr>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 border-black">{info.country}</td>
                  </tr>
                  <tr>
            ...
            <table className="table-auto w-full">
              ...
              <tbody>
                {education?.postGraduation?.map((x, i) => (
                  <tr key={i}>
                    {x.from && (<td className="border px-4 py-2 font-bold border-black">{x.name}</td>)}
                ...
                {education?.blankYear?.map((x, i) => (
                  <tr key={i}>
                    {x.from && (<td className="border px-4 py-2 font-bold border-black">Blank-Year</td>)}
                    {x.from && (<td className="border px-4 py-2 border-black">{formatDate(x.from)} - {formatDate(x.to)}</td>)}
                    {x.from && (<td className="border px-4 py-2 border-black"></td>)}
                    {x.from && (<td className="border px-4 py-2 border-black">{/* Place and State Data */}</td>)}
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <div className="w-full ">
              <table className="table-auto w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border px-4 py-2 font-bold border-black">{English}</td>
                    <td className="border px-4 py-2 border-black">
                      <input
                        type="radio"
                        value="Good"
                        checked={education?.english === 'Good/ Gut'}
                    ...
                    <td className="border px-4 py-2 border-black">
                      <input
                        type="radio"
                        value="Average"
                        checked={education?.english === 'Average/ Durchschnittlich'}
  
                      />
                      {average}
                    </td>
                    <td className="border-r  flex  px-4 py-2 border-black">
                      <input
                        type="radio"
                        value="Bad"
                        checked={education?.english === 'Poor /Schlecht'}
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 font-bold bg-gray-300 border-black" >{certificate} </td>
                  ...
                  {work?.map((x, i) => {
                    ...
                    return (
                      <React.Fragment key={i}>
                        ...
                        <tr>
                          <td className="border px-4 py-2 border-black">Duties handled</td>
                          <td className="border px-4 py-2 border-black" colSpan={3}>
