    ...
    `}
      ...
      <Stack spacing={4} m={6} fontFamily="sans-serif">
        ...
        <VStack spacing={2} align="stretch">
          <Heading as="h2" fontSize="md" borderBottomWidth="1px">
        ...
        {Object.keys(education).length > 0 ? (<VStack spacing={1} align="stretch">
          <Heading as="h3" fontSize="md" borderBottomWidth="2px">
            {headName}
          </Heading>
...
<br />
  ...
  <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
    ...
    {x.writingMarksheetDate && <li>writingMarksheet :- {formatBirthDate(x.writingMarksheetDate)}</li>}
        ...
        <br />
        {option == 'no' || option == 'yes' || (work?.[0]?.employer || internship?.[0]?.hospital) ? (<Heading as="h3" fontSize="md" borderBottomWidth="1px">
          {headW}
        </Heading>) : ''}
...
<div className="flex justify-between mx-8 my-4">
  ...
  document.body.style.zIndex = '0'; // Reduce z-axis
  window.print();
  document.body.style = originalBodyStyle;
}}>Download</Button>
     </Box>
