...
const RegistrationPage = (props) => {
  ...
  if (!phoneRegex.test(formData.phn)) {
    ...
    const res = await axios.post(`https://testapi1.nursingpioneer.com/registerStudent`,formData);
    if(res.data.success){
        ...
        {registrationComplete ? (
          ...
          <form>
            <FormControl mb={4} isRequired>
              <FormLabel>Register with your actual name on your Passport</FormLabel>
            ...
            <FormControl mb={4} isRequired>
              <Select color="black" bg="white" placeholder="Select an option"
                value={formData.que}
                onChange={(e) => {
                  setFormData(prev => ({ ...prev, que: e.target.value }))
                }}
              >
              ...
              <Input
                ...
                value={formData.ans}
                onChange={(e) => {
                  setFormData(prev => ({ ...prev, ans: e.target.value }))
                }}
                color="black"
                bg="white"
              />
            ...
            <Stack spacing={4}>
              ...
              <Button onClick={handleRegistration} colorScheme="blackAlpha" width="100%" isDisabled={!formData.termsAccepted}>
                Register
              </Button>
            </Stack>
          </form>
